...
<@layout.registrationLayout displayMessage=!messagesPerField.existsError('username','password') displayInfo=realm.password && realm.registrationAllowed && !registrationDisabled??; section>
    ...
    <#elseif section = "form">
        <div class="mz-login-widget">
            ...
            <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                ...
                <div class="mz-input-group">
                    ...
                    <input tabindex="2" id="password" name="password" type="password" 
                           ...
                           aria-invalid="<#if messagesPerField.existsError('username','password')>true</#if>" />
                    <button type="button" class="mz-password-toggle" onclick="togglePassword()" tabindex="3">
                ...
                <button tabindex="5" type="submit" id="kc-login" class="mz-submit">
                    Sign In
                </button>
            </form>
            ...
            <#else>
                <div class="mz-register">
                    Don't have an account? <a href="https://auth.mozaiks.ai/realms/mozaiks/account/">Sign Up</a>
                </div>
            </#if>
        </div>
